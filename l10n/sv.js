OC.L10N.register(
    ...
    "TOTP (Authenticator app)" : "Two-Factor Authentication (2FA Autentiseringsapplikation)",
    "Authenticate with a TOTP app" : "Autentisera med en 2FA-app",
    "Two-Factor TOTP Provider" : "Tvåfaktor TOTP-leverantör",
    ...
    "Enable TOTP" : "Aktivera 2FA",
    "Could not enable TOTP" : "Kunde inte aktivera 2FA",
    "Could not verify your key. Please try again" : "Kunde ej verifiera din nyckel. Vänligen försök igen",
    "Your new TOTP secret is:" : "Din nya 2FA-hemlighet är:",
    "For quick setup, scan this QR code with your TOTP app:" : "För snabb installation, skanna den här QR-koden med din 2FA-app:",
    "After you configured your app, enter a test code below to ensure everything works correctly:" : "När du har konfigurerat din app, ange en testkod nedan för att säkerställa att det fungerar:",
